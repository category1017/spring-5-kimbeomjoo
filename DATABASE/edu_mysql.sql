...
--
-- Table structure for table `tlbl_attach`
--

DROP TABLE IF EXISTS `tlbl_attach`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tlbl_attach` (
...
--
-- Dumping data for table `tlbl_attach`
--

LOCK TABLES `tlbl_attach` WRITE;
/*!40000 ALTER TABLE `tlbl_attach` DISABLE KEYS */;
/*!40000 ALTER TABLE `tlbl_attach` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2020-12-23 15:32:46
