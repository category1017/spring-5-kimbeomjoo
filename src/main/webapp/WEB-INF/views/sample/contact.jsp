...
<section class="contact-section"><!-- division이라는 div 영역표시 태그 대신에 사용-->
<h1>CONTACT</h1>
<div class="container">
...
<!-- 스프링에서는 action으로 폼데이터를 전송할 위치를 지정할때, contact.html직접x /contact처럼 컨트롤러를 통해 ok -->
...
<input name="phone" id="phone" type="text" placeholder="연락처 입력">
