						...
						<li class="clear">
		                    ...
		                    <div class="div_file">
			                    <div class="custom-file" style="width:96%;margin:0 2%;">
				                    ...
				                    <label class="custom-file-label" for="customFile" style="color:#999;">파일첨부${index+1}</label>
				                </div>
				                <c:if test="${boardVO.save_file_names[index] != null}">
									<br>
									<div class="tit_lbl" style="width:100%">
									<a href="/download?save_file_name=${boardVO.save_file_names[index]}&real_file_name=${boardVO.real_file_names[index]}">${boardVO.real_file_names[index]}다운로드 링크[${index+1}]</a>
									&nbsp;&nbsp;
