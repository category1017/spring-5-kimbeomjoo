...
<%@ include file="../include/header.jsp" %>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">게시판타입등록</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">게시판타입등록</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
					...
					<div class="card card-primary">
						...
						<div class="card-body">
							<div class="form-group">
								<label for="board_type">게시판타입</label><!-- 게시판타입은 ID이기 때문에 중복값등록 불가  --> 
 ...
 <!-- 현재 J쿼리코어파일이 footer.jsp에 있기 때문에, 아래 JQuery실행은 코어 아래쪽에 있어야함 -->
...
jQuery(document).ready(function(){
	jQuery("#board_type").bind("blur",function(){
		if(jQuery(this).val() !="") {
			...
			if(jQuery.inArray(jQuery(this).val(),board_type_array) >= 0){//자바변수값과 input게시판타입값 비교해서 있으면0보다 큰숫자가 나옵니다. 
				//inArray함수는 반환값이 인덱스값을 반환합니다. 0보다크면 인젝스가 존재 
				alert("기존 게시판이 존재합니다. 다시 입력해주세요")
