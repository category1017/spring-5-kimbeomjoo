...
public class MemberServiceImpl implements IF_MemberService {
	...
	public void herokuJobMethod() throws Exception {
		// 월-금 오전8시부터 오후11시 (미국시간 23,0-14) 헤로쿠앱에 20분 간격으로 URL접근
		String urlStr ="https://spring5-kimbeomjoo.herokuapp.com";//본인앱주소
		...
		urlConnection.setReadTimeout(10000);//접속대기시간을 10초. 헤로쿠 20초 ZZZ깨어남
		//개발자 확인 코드(아래)
	...
	public void testJob() throws Exception {
		...
		System.out.println("6개월 동안 회원정보 수정이 없는 회원정보는 아래입니다. ");
